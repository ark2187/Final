...
<img align="left" src="images/us_border.jpg" style="width:60%; margin-right: 20px"  > 
...
* Seasonal trend in border crossings <br>
* Comparison of border crossings between non-vehicle vs. vehicle and difference in trends for each vehicle type. 

In the Shinyapp tab, we provide three interactive maps <br>

* Chart A: Map to show the border crossing number based on customized forBorder choice, Year, State setting <br>
* Chart B: Boxplot to show distribution of the number or crossings for corresponding border states
* Chart C: Monthly Trends for States for Selected Crossing Types

Our final project report can be found here. A brief screencast of our project can be found here. [link](https://github.com/ark2187/Final/report.html)
